...
export class SignosVitalesGuardService implements CanActivate {
  ...
  canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): boolean {
    ...
    roles.forEach(rol => {
      ...
      if( rol === 'ROL_PACIENTES' ){
        this.realRol.push('pacientes');
      }
      if( rol === 'ROL_ABM_PACIENTE' ){
        this.realRol.push('paciente');
      }
    });
